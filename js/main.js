  ...
  function closeMenu(theID) {
	...
	$(function() {
		...
		$('nav').bind('nav-update', function(e,data){;
			...
			eSysmsg.each(function(){
				text = $(this).text();
                                
                                if ($.trim(text) !== '' && $('#alert').css('display') !== 'block') {
                                 $('#notifications-slider').append("<li>"+text+"</li>");
                                 //alert(text);
                                 doSlider = true;
                                }
			});
                         ...
                         if (doSlider) {
                          ...
                          $('#notifications-slider').bxSlider({ controls : false, speed : 200, auto : true, mode : 'vertical', slideMargin: 2 });
                         }
                         
                        }
                                
                        $('#alert .close-slider').click(function(){
                          $('#alert').slideUp('fast');
                        });
